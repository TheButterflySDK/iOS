...
Just: place the Butterfly report button + use a valid API key = you're good to go!
  ...
  s.homepage         = 'https://github.com/perrchick/TheButterflyHost-iOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'perrchick' => 'perrchick@gmail.com' }
  s.source           = { :git => 'https://github.com/perrchick/TheButterflyHost-iOS.git', :tag => s.version.to_s }
